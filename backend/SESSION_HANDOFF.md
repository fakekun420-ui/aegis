...
- **Hub:** `1.18.31`, `ready:true healthy:true` on `127.0.0.1:49374`, ownership `termux-native` (PID 27592) — do not touch live DB; hub serves `public/app.js` with `Cache-Control:no-cache`.
