...
export class AgentPool {
  ...
  async dispatch(agentType, projectId, context) {
    ...
    if (projAgents.length >= 2) {
      throw new Error("Concurrency limit reached: max 2 agents per project");
    }
